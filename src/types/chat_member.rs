...
pub struct ChatMember {
    ...
    /// Optional. Administrators only. True, if the administrator can change the chat title, photo
    /// and other settings
    ...
    /// Optional. Administrators only. True, if the administrator can delete messages of other
    /// users
    ...
    /// Optional. Administrators only. True, if the administrator can pin messages, groups and
    /// supergroups only
    ...
    /// Optional. Restricted only. True, if the user can send text messages, contacts, locations
    /// and venues
    pub can_send_messages: Option<bool>,
    /// Optional. Restricted only. True, if the user can send audios, documents, photos, videos,
    /// video notes and voice notes, implies can_send_messages
    pub can_send_media_messages: Option<bool>,
    /// Optional. Restricted only. True, if the user can send animations, games, stickers and use
